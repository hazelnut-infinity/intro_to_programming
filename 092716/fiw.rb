  ...
  full = {
      ...
      33 => "thirty three",34 => "thrity four", 35 => "thirty five", 36 => "thirty six", 37 => "thirty seven", 
...
next2 = [type[1],type[2]].join.to_i #define two consecutive integers
if type.length == 1
 ary.push([full[type[0]], full["$"]].join(" "))
    ...
    ary.push([full[type[0]],full[100],full["&"],full[last2], full["$"]].join(" "))  #first index, append 100 to it then add and
     ...
     ary.push([full[type[0]],full[1000],full[type[1]],full[100],full["&"],full[last2], full["$"]].join(" "))
      ...
      ary.push([full[first2],full[1000],full[type[1]],full[100],full["&"], full[last2], full["$"]].join(" "))
elsif type.length == 6
      ary.push([full[type[0]],full[100],full["&"],full[next2],full[1000],full[type[3]],full[100],full["&"],full[last2], full["$"]].join(" "))
elsif type.length == 7
  ary.push([full[type[0]],full[1000000],full[type[1]],full[100],full["&"],full[next2],full[1000],full[type[4]], full[100], full["&"], full[last2], full["$"]].join(" "))     
elsif type.length == 8
  ary.push([full[first2], full[1000000],full[type[2]],full[100],full["&"],full[next2],full[1000], full[type[5]],full[100],full["&"],full[last2], full["$"]].join(" "))            

elsif type.length == 9
   ary.push([full[type[0]],full[1000000000],full[type[1]],full[100],full["&"],full[next2],full[1000000],full[type[4]], full[100], full["&"],full[next2],full[1000],full[type[6]],full[100], full["&"], full[last2], full["$"]].join(" "))
elsif type.length == 10
      ary.push([full[first2], full[1000000000], full[type[2]], full[100], full["&"], full[next2], full[1000000], full[type[4]], full[100], full[next2], full[1000], full[7], full[100],full["&"], full[last2], full["$"]].join(" "))
elsif type.length == 11
      ary.push([full[type[0]], full[100], full["&"], full[next2], full[1000000000], full[type[3]], full[100], full[next2], full[1000000], full[type[6]], full[100], full["&"], full[next2],full[1000], full[type[9]], full[100], full["&"], full[last2], full["$"]].join(" "))
elsif type.length == 12
ary.push([full[type[0]], full[1000000000000], full[type[1]], full[100], full["&"], full[next2], full[1000000000], full[type[4]], full[100], full["&"], full[next2], full[1000000], full[type[7]],full[100], full["&"], full[next2], full[1000], full[10], full[100], full["&"], full[last2], full["$"]].join(" "))      
end 
